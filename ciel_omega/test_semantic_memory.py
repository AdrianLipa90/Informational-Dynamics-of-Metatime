...
def main():
    results = [
        test_1_repeated_episodes_create_candidate(),
        test_2_single_episode_no_item(),
        test_4_surface_duplicates_same_key(),
        test_5_retrieval_prefers_high_confidence_alignment(),
        test_7_no_direct_path_to_m6_or_identity_mutation(),
    ]
